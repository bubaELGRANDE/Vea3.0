...
// Rutas de Productos
rutas.get("/products", (res: Response) => productController.getProducts(res));
...
rutas.get("/products/seller/:sellerId", (req: Request, res: Response) => productController.getProductsBySellerID(req, res));

// Rutas de Vendedores
rutas.get("/sellers", (res: Response) => sellersController.getAllSellers(res));
...
rutas.get("/buyers", (res: Response) => buyersController.getAllBuyers(res));
...
// Rutas de Reviews
rutas.get("/reviews", (res: Response) => reviewsController.getReviews(res));
...
// Rutas de Chat
rutas.get("/chat", (res: Response) => chatController.getChats(res));
...
rutas.get("/departments", (res: Response) => departmentsController.getDepartments(res));
rutas.get("/departments/:id", (req: Request, res: Response) => departmentsController.getDepartmentById(req, res));

// Rutas de Municipalities
rutas.get("/municipalities", (res: Response) => departmentsController.getMunicipalities(res));
