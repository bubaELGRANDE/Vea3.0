...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Users_1.Users, user => user.refreshTokens, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'userId' }) // Cambiado de nuevo a userId
    ,
...
], RefreshToken.prototype, "issuedTime", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'timestamp',
        nullable: false,
    ...
    __metadata("design:type", Date)
], RefreshToken.prototype, "expiredTime", void 0);
